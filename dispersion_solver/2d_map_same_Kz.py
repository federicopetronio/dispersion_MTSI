...
print("AT: ", 314*prt_base.Debye_length, 614*prt_base.Debye_length)
Lr=0.0128*u.m
kz = 2*np.pi/Lr
...
for index,dindondensity in enumerate(densities):
    ...
    if primo:
        ...
        gioco_omega = np.arange(0.65*ome/(u.rad/u.s),1.05*ome/(u.rad/u.s),5e4)*u.rad/u.s
        gioco_gamma = np.arange(0.95*gam/(u.rad/u.s),1.05*gam/(u.rad/u.s),5e4)*u.rad/u.s
