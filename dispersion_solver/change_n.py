...
try:
    os.mkdir(sentierino + "/dispersion_data/change_n")
except:
    print("already existing folder dispersion_data/change_n")
try:
    os.mkdir(sentierino + "/dispersion_data/change_n/{:}/".format(plasmaDensity*u.m**(3)))
except:
