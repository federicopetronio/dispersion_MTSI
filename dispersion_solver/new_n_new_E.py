...
try:
    os.mkdir(sentierino + "/dispersion_data/change_n_E")
except:
    print("already existing folder dispersion_data/change_n_E")
try:
    os.mkdir(sentierino + "/dispersion_data/change_n_E/{:}_{:}/".format(electricField*u.m**(1)/u.V,plasmaDensity*u.m**(3)))
except:
